...
<?php
ob_start();
define('API_KEY', '1176554684:AAF-1Y4nlXJd0zv3MpDrk6nWsYGAOTk6Ltk8');
//tokenni yozing
$admin = "671079965"; 
...
if($text1 == "/start" or $text1 == "/start@Salomovrobot"){
...
[📺Kanalimizga obuna](https://t.me/hacker_xacker_SA) 👈",
]);
}
...
bot('sendMessage',[ 
     'chat_id'=>$cid2, 
     'text'=>"*Assalomu alaykum hurmatli foydalanuvchi botga xush kelibsiz @Salomovrobot dan foydalanishingiz uchun ro'yxatdan o'tishingiz kerak*",
        'parse_mode'=>"markdown",
        'reply_markup'=>json_encode(
...
if($text1 == "🔓Boshlash" or $text1 == "/start@Salomovrobot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$st = bot('sendMessage',[
'chat_id'=>$chat_id,
...
<b>📲Yangiliklar @hacker_xacker_SA
🎓Admin @SalomovAsliddin</b>",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'🔥Buyruqlar', 'callback_data' => "stat"],['text'=>'📌Statistika', 'callback_data' => "stat1"]],
         [['text'=>'🔬Foydali Bolim', 'callback_data' => "qiziqarlik"],['text'=>'📰Foydali buyuruqlar', 'callback_data' => "ʼfoydalibuyi"]],
            [['text'=>'💥Pul Ishlash', 'callback_data' => "pulishlash"],['text'=>'🇺🇿Telegram Tillar🇺🇸', 'callback_data' => "tillar"]],
               [["switch_inline_query"=>"@", 'text' => "🆔Sinab korish"],['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/@Salomovrobot?startgroup=new']]
]
]),
]);
}
  ...
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'🔥Buyruqlar', 'callback_data' => "byuruq"],['text'=>'📌Statistika', 'callback_data' => "stat1"]],
         [['text'=>'🔬Foydali Bolim', 'callback_data' => "qiziqarlik"],['text'=>'📰Foydali buyuruqlar', 'callback_data' => "ʼfoydalibuyi"]],
            [['text'=>'💥Pul Ishlash', 'callback_data' => "pulishlash"],['text'=>'🇺🇿Telegram Tillar🇺🇸', 'callback_data' => "tillar"]],
               [["switch_inline_query"=>"@", 'text' => "🆔Sinab korish"],['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Nazoratshi_Red_Bllogerr_bot?startgroup=new']]
]
]),
]);
}
...
if($data=="ybn"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "👮<b>Salom ,mening ismim Red Bllogerr QR Do‘stlarim esa Red Bllogerr deb chaqirishadi!
...
🍁Yangiliklar: @hacker_xacker_SA</b>",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'🔥Buyruqlar', 'callback_data' => "boshqabu"],['text'=>'📌Statistika', 'callback_data' => "statais"]],
         [['text'=>'➕Guruhga qo‘shish','url'=>'telegram.me/@Salomovrobot?startgroup=new']]
]
]),
]);
}
...
if($text1 == "/botishla" or $text1 == "/botishla@Nazoratshi_Red_Bllogerr_bot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$st = bot('sendMessage',[
'chat_id'=>$chat_id,
...
['inline_keyboard' => [
  ...
  [['text'=>'➕Guruhga Qo‘shish','url'=>'telegram.me/Nazoratshi_Red_Bllogerr_bot?startgroup=new']]
]
]),
]);
}
...
Yaratuvchi🛠:  [#SalomovAsliddin](t.me/SalomovAsliddin)",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
...
'reply_markup' => json_encode([
                'inline_keyboard'=>[
[['text'=>'🤘Mega Xakkerlar','url'=>'https://t.me/QR_XAKKER']],
     [['text'=>'☀SPORT','url'=>'https://t.me/QR_XAKKER']],
         [['text'=>'💻Php Kod','url'=>'https://t.me/QR_XAKKER']],
             [['text'=>' 💫Orqaga qaytish','callback_data'=>'qiziqarlik']]
]
]),
]);
...
bot('sendMessage',[
'chat_id'=>$cid,
'text'=>"Xatolik #1. Iltimos shu xabarni [@Salomovasliddin] ga yuboring!",
'parse_mode'=>markdown,
'reply_markup'=>$admo,
]);
}
...
if($data=="reklaaammaa"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
        'text'=>"Bot admini va reklama bo'yicha: [#SalomovAsliddin](https://t.me/SalomovAsliddin)
Yangiliklar: [Mega Xakkerlar](https://t.me/hacker_xacker_SA)
Telefon: +998990255965
 Ish Vaqti: 16:00 - 23:00
Bot yasattirish uchun [#SalomovAsliddin](https://t.me/@hacker_xacker_SA) *bilan narxlarni kelishib oling*",
'parse_mode'=>markdown,
'reply_markup' => json_encode([
                'inline_keyboard'=>[
[['text'=>'🎩Admin','url'=>'https://t.me/Red_Bllogerr_QR']],
    [['text'=>'📲Spamlar Uchun','url'=>'https://t.me/Red_BlIogerr_QR_Robot']],
        [['text'=>' 💫Orqaga qaytish','callback_data'=>'qiziqarlik']]
]
]),
]);
...
'reply_markup' => json_encode([
                'inline_keyboard'=>[
[['text'=>'🎓Admin','url'=>'https://t.me/Red_Bllogerr_QR'],['text'=>'💻Spamlar Uchun','url'=>'https://t.me/Red_BlIogerr_QR_Robot']],
[['text'=>' 💫Orqaga qaytish','callback_data'=>'qiziqarlik']]
]
]),
]);
...
'reply_markup' => json_encode([
                'inline_keyboard'=>[
[['text'=>'Admin bilan aloq 🤖','url'=>'https://t.me/Red_BlIogerr_QR_Robot']],
     [['text'=>'Kanalimiz boti','url'=>'https://t.me/QR_XAKKER_ROBOT']],
                   [['text'=>' ??Orqaga qaytish','callback_data'=>'qiziqarlik']]
]
]),
]);
...
if($data=="Namoz"){
$nv = file_get_contents("http://islom_Salomov/");
$ex = explode("\n",$nv);
$a = trim($ex[393]);
...
if($text1 == "/panel" or $text1 == "/panel@Salomovrobot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
['inline_keyboard' => [
[['text'=>' 💫Orqaga qaytish', 'callback_data' => "back"]],
   [['url' => 'https://telegram.me/Nazoratshi_Red_Bllogerr_bot?startgroup=new', 'text' => "➕Guruhga Qo‘shish"]]
]
]),
]);
}
...
// @SalomovAsliddin @hacker_xacker_SA
if(isset($text1)){
...
[['text'=>"🆕 YANGILIKLAR 🆕",'callback_data'=>"yangilik"]],
  ...
  $url = 'https://@hacker_xacker_SA/feed/';
...
if(mb_stripos($query,"kurs")!==false){
  bot('answerInlineQuery',[
    ...
    'results'=>json_encode([[
    'type'=>'article',
    'thumb_url'=>"https://https://izzatbek8252.000webhostapp.com/polo/kurs.jpg",
    'id'=>base64_encode(1),
    'title'=>"💱 VALYUTA KURSI 💱",
...
if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@Salomovrobot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
if($text1 == "/adminlist"){
      bot('sendmessage',[
        'chat_id'=>$chat_id,
        'text'=>"👮Creator @SalomovAsliddin
👨‍✈️Admin @salomovasliddin

🛎Kanalimiz  @hacker_xacker_SA",
]);
}
...
if(mb_stripos($text1,".com")!==false){ bot('deleteMessage',[ 'chat_id'=>$cid, 'message_id'=>$mid, 'text1'=>"Xabaringiz o‘chirildi🛡",
    ...
    if($data == "admin"){
      bot('answerCallbackQuery',[
       'callback_query_id'=>$cqid,
       'text'=> "🔷Bot admini @SalomovAsliddin agar sizga ham bot kerak bo'lsa adminga murojat qiling",
       'show_alert'=>true
        ]);
    }
      ...
      bot('answerCallbackQuery',[
       'callback_query_id'=>$cqid,
       'text'=> "@hacker_xacker_SA kanali adminlariga minodorshilik bildiraman. @Red_Bllogerr_QR",
       'show_alert'=>true
        ]);
    }
...
'caption'=>"Sport logotip by @Salomovrobot
You write $ex[1]",
]);
} 
...
'caption'=>"Best logotip by @salomovrobot
You write $ex[1]",
]);
} 
...
'caption'=>"QR CODE by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"Epic logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"Crazy logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"Music logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"game logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"men logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"girl logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"Fest logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"moto logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"Cars logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
'caption'=>"DJ logotip by @Salomovrobot
You write $ex[1]",
]);
}
...
You write $ex[1]",
   ...
   'text'=>$EN[1],
    ...
    //-_-_-_-_-_-_-_-_-_-_@Red_Bllogerr_QR-_-_-_-_-_-_-_-_-_//
...
//-_-_-_-_-_-_-_-_-_-_ders_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_s_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_ders_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-__-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-__-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-__-_-_-_-_-_-_-_-_//
...
$EN9 =   explode("/nick", $text1);
 ...
 //-_-_-_-_-_-_-_-_-_-N_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_N_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-ON_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_N_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@D_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-__-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_N_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_N__-_-_-_-_-_-_-_-_//
...
if((mb_stripos($mtext,"#Taklif") !== false) or (mb_stripos($mtext,"Red Bllogerr")!==false) or (stripos($mtext,"@QR_XAKKER_GR")!==false) or (mb_stripos($mtext,"@Red_BlIogerr_QR_Robot")!==false) or (mb_stripos($mtext,"QR_XAKKER")!==false)){ 
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
...
if($text1 == "/ro" or $text1 == "/Ro" or $text1 == "RO" or $text1 == "ro@Nazoratshi_Red_Bllogerr_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1 == "/pin" or $text1 == "/Pin" or $text1 == "PIn" or $text1 == "PIN" or $text1 == "piN" or $text1 == "pIN" or $text1 == "pIn" or $text1 == "pIN@Nazoratshi_Red_Bllogerr_bot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
